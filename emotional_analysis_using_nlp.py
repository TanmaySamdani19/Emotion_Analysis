# -*- coding: utf-8 -*-
"""Emotional Analysis using NLP

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1MCeDuSfTC31P_mEkbX_Gfx8lbsUsrrkR
...
"""Convert your data in machine understanding language"""

df_train = pd.read_csv('train.txt')
df_train.head()
#df_train[1]-- gives error as data not arranged in column format

"""Here we see that the data is just seperated using ';' so it is not in column format so we  need to convert them in column format"""
